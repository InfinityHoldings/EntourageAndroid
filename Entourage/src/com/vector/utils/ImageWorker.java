...
public abstract class ImageWorker {
	...
	public void loadImage(Object data, ImageView imageView) {
		...
		if (value != null) {
			...
			Log.i(TAG, "Image found in memory cache " + data);
	...
	// running based on bitmap.
	public void setLoadingImage(Bitmap bitmap) {
		mLoadingBitmap = bitmap;
	}

	// Set placeholder bitmap that shows when the the background thread is
	// running (based on resource id).
	...
	public void addImageCache(FragmentManager fragmentManager,
		...
		new CacheAsyncTask().doInBackground(MESSAGE_INIT_DISK_CACHE);
	}
	...
	// Returns the ImageCache object currently being used by this ImageWorker.
	...
	private class BitmapWorkerTask extends
		...
		protected BitmapDrawable doInBackground(Void... params) {
			...
			if (mImageCache != null && !isCancelled()
				...
				Log.i(TAG, "Loaded image from disk cache " + dataString);
			...
			if (bitmap != null) {
				...
				if (mImageCache != null) {
					Log.i(TAG, "Image added to cache " + dataString);
	...
	public void clearCache() {
		new CacheAsyncTask().doInBackground(MESSAGE_CLEAR);
	}

	public void flushCache() {
		new CacheAsyncTask().doInBackground(MESSAGE_FLUSH);
	}

	public void closeCache() {
		new CacheAsyncTask().doInBackground(MESSAGE_CLOSE);
	}
}
