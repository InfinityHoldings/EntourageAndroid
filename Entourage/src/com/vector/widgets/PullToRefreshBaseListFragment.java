...
abstract class PullToRefreshBaseListFragment<T extends PullToRefreshBase<? extends AbsListView>>
	...
	public final View onCreateView(LayoutInflater inflater,
		...
		mPullToRefreshListView = onCreatePullToRefreshListView(inflater,
				savedInstanceState);
	...
	// return The PullToRefreshBase attached to this ListFragment.
	public final T getPullToRefreshListView() {
		return mPullToRefreshListView;
	}

	// Returns the {@link PullToRefreshBase} which will replace the ListView
	// created from ListFragment.
	protected abstract T onCreatePullToRefreshListView(LayoutInflater inflater,
