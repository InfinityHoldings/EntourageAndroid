...
import com.vector.widgets.EmptyViewMethodAccessor;
...
import com.vector.widgets.PullToRefreshAdapterViewBase;
...
public class PullToRefreshListView extends
	...
	protected class InternalListView extends ListView implements
		...
		// Samsung listView has a bug when the view is empty, this corrects the
		// issue.
		@Override
